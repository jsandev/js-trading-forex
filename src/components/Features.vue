<template>
  ...
  >
    <div class="flex flex-col items-center gap-[1rem]">
      <h1 class="text-[1.75rem] text-primary text-center">Características</h1>
      <p
        class="w-full max-w-[40.3125rem] font-raleway font-medium text-[1rem] text-center text-secondary"
      >
        Conoce lo que puedes encontrar en nuestra app
      </p>
    </div>
      ...
      >
        ...
        <div class="w-full max-w-[29.6875rem] flex flex-col gap-[1.5rem]">
          ...
          >
            ...
            el éxito en el fascinante mundo del intercambio de divisas
          </p>
        </div>
      </div>
    </div>
